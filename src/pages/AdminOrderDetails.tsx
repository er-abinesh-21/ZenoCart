        ...
        <CardHeader>
          <div className="flex justify-between items-start">
            <div>
              ...
              <CardDescription>
                Placed on {new Date(order.created_at).toLocaleDateString()} by {order.shipping_name}
              </CardDescription>
            </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              {order.order_items.map((item, index) => (
                <div key={index} className="flex items-center gap-4 p-2 rounded-md bg-gray-50">
